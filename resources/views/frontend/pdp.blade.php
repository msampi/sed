  ...
  <table class="table table-bordered objective-table">
      ...
      <tbody>
        <tr>
          ...
          <td><textarea placeholder="{!! $dictionary->translate('Comentarios empleado') !!}" data-id="{!! $comment->id !!}" data-entry="user"  data-stage="half-year" data-uid="{!! $user->id !!}" data-eid="" class="form-control comment" @if (!$is_logged_user || $current_stage != 2) disabled @endif>{!! $comment->comment !!}</textarea>
          </td>
          {{-- */ $comment = $plan_comments->getComment($user->id, 'end-year', 'user', 1) /* --}}
          <td><textarea placeholder="{!! $dictionary->translate('Comentarios empleado') !!}" data-id="{!! $comment->id !!}" data-entry="user"  data-stage="end-year" data-uid="{!! $user->id !!}" data-eid="" class="form-control comment" @if (!$is_logged_user || $current_stage != 3) disabled @endif>{!! $comment->comment !!}</textarea>
          </td>
        </tr>
        <tr>
          @if ($visualization_st1)
          {{-- */ $comment = $plan_comments->getComment($user->id, 'half-year', 'evaluator', 1) /* --}}
          <td><textarea placeholder="{!! $dictionary->translate('Comentarios manager') !!}" data-id="{!! $comment->id !!}" data-entry="evaluator"  data-stage="half-year" data-uid="{!! $user->id !!}" data-eid="{!! Auth::user()->id !!}" class="form-control comment" @if ($is_logged_user || $current_stage != 2) disabled @endif>{!! $comment->comment !!}</textarea>
          </td>
          @endif
          @if ($visualization_st2)
          {{-- */ $comment = $plan_comments->getComment($user->id, 'end-year', 'evaluator', 1) /* --}}
          <td><textarea placeholder="{!! $dictionary->translate('Comentarios manager') !!}" data-id="{!! $comment->id !!}" data-entry="evaluator"  data-stage="end-year" data-uid="{!! $user->id !!}" data-eid="{!! Auth::user()->id !!}" class="form-control comment" @if ($is_logged_user || $current_stage != 3) disabled @endif>{!! $comment->comment !!}</textarea></td>
          @endif
        </tr>
      </tbody>
  </table>
      ...
      <tbody>
        <tr>
          <td>
            ...
            <textarea data-id="{!! $comment->id !!}" data-entry="user"  data-stage="half-year" data-eid="" data-uid="{!! $user->id !!}" class="form-control comment" placeholder="{!! $dictionary->translate('Comentarios empleado') !!}" @if (!$is_logged_user || $current_stage != 2) disabled @endif>{!! $comment->comment !!}</textarea><br>
            @if ($visualization_st1)
            {{-- */ $comment = $plan_comments->getComment($user->id, 'half-year', 'evaluator', 2) /* --}}

            <textarea data-id="{!! $comment->id !!}" data-entry="evaluator"  data-stage="half-year" data-eid="{!! Auth::user()->id !!}" data-uid="{!! $user->id !!}" class="form-control comment" placeholder="{!! $dictionary->translate('Comentarios manager') !!}" @if ($is_logged_user || $current_stage != 2) disabled @endif>{!! $comment->comment !!}</textarea>
            @endif
          </td>
      ...
      <tbody>
        <tr>
          <td>
            ...
            <textarea data-id="{!! $comment->id !!}" data-uid="{!! $user->id !!}" data-entry="user"  data-stage="end-year" data-eid="" class="form-control comment" placeholder="{!! $dictionary->translate('Comentarios empleado') !!}" @if (!$is_logged_user || $current_stage != 3) disabled @endif>{!! $comment->comment !!}</textarea><br>
            @if ($visualization_st2)
            {{-- */ $comment = $plan_comments->getComment($user->id, 'end-year', 'evaluator', 2) /* --}}
            <textarea data-id="{!! $comment->id !!}" data-uid="{!! $user->id !!}" data-entry="evaluator"  data-stage="end-year" data-eid="" class="form-control comment" placeholder="{!! $dictionary->translate('Comentarios manager') !!}" @if ($is_logged_user || $current_stage != 3) disabled @endif>{!! $comment->comment !!}</textarea>
            @endif
          </td>
